...
public class SalesItemTest
{
    ...
    public void setUp()
    {
        salesIte1 = new SalesItem("pink dildo", 2500);
        salesIte2 = new SalesItem("used pink dildo", 1250);
        salesIte2.addComment("Bobby Brown", "It was covered in Jane's fucking crusty jizz...", 1);
        salesIte2.addComment("John Doe", "Hrm, I seem to have purchased my wife's dildo, awkward.", 3);
    }
    ...
    @Test
    public void testGetBestComment()
    {
