...
/**
 * <h1>Non-Palindromic Primes</h1>
 * <p>
 * This program will print the first 100 non-palindromic primes. A non-palindromic prime is a prime number that isn't a palindrone.
 * </p>
 * <p>
...
public class Question27
{
	...
	public static void main(String[] args)
	{
		...
		List<Integer> nonpalindromicPrimes = new ArrayList<>();
		while(!done)
		{
			...
			{
				nonpalindromicPrimes.add(number);
				counter++;
			}
			number++;
		...
		counter = 1;
		for(Integer aNumber :  nonpalindromicPrimes)
		{
