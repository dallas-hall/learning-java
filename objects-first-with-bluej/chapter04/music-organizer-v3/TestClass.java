...
public class TestClass
{
     ...
     * list all files - using for each loop WITH counter
     */
    public void testPlayFileByName(String searchString)
    {
        musicOrg1.playAll(searchString);
    }
    
     /**
     * list all files - using for each loop WITH counter
     */
    public void testPlayFileByName2(String searchString)
    {
        musicOrg1.playAllCUDying(searchString);
    }
