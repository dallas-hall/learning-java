...
public class IntegerArraySorting
{
    ...
    {
        printArrayNoSorting();
        printAutomagicallyAscendingSortedArray();
        printManuallyAscendingSortedArray();
        printManuallyDescendingSortedArray();
    }
    ...
    public void printAutomagicallyAscendingSortedArray()
    {
        System.out.println("The automagically ascending sorted array is...");
    ...
    public void printManuallyAscendingSortedArray()
    {
        // create a new array
        ...
        for (int i = 0; i < mySortedIntArray.length; i++)
        {
            ...
            for (int j = (i + 1); j < mySortedIntArray.length; j++)
            {
                ...
                if (mySortedIntArray[j] < tmpMinValue)
                {
                    tmpIndex = j;
        ...
        // print the sorted array
        System.out.println("The manually ascending sorted array is...");
        for (int i = 0; i < mySortedIntArray.length; i++)
        {
    ...
    public void printManuallyDescendingSortedArray()
    {
        // create a new array
        int[] mySortedIntArray = new int[intArray.length];
        ...
        for (int i = 0; i < mySortedIntArray.length; i++)
        {
            ...
            // if there was higher value found, do an update.
            if (tmpIndex != i && tmpMinValue != intArray[i])
            {
                mySortedIntArray[tmpIndex] = mySortedIntArray[i];
                mySortedIntArray[i] = tmpMinValue;
        ...
        // print the sorted array
        System.out.println("The manually descending sorted array is...");
        for (int i = 0; i < mySortedIntArray.length; i++)
        {
            System.out.println(mySortedIntArray[i]);
        }
